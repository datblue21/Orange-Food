...
public class RestaurantController {
    ...
    public ApiResponse<Restaurant> createRestaurant(
        ...
        response.setResult(
                restaurantService.insertRestaurant(file, title, subTitle, description, isFreeship, address, openTime));
        return response;
    }
    ...
    public ApiResponse<Restaurant> updateRestaurant(
        ...
        response.setResult(restaurantService.updateRestaurant(id, title, subTitle, description, address));
        return response;
    }

    @DeleteMapping("/{id}")
    public ApiResponse<?> deleteRestaurant(@PathVariable int id) throws Exception {
